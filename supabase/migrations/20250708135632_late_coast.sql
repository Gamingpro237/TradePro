/*
  ...
  2. Security
    - Add RLS policies for user_profiles and user_settings
...
-- Add RLS policies for user_profiles with public role access
...
-- Drop existing user_settings policies to avoid conflicts
