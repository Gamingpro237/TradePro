...
DROP FUNCTION IF EXISTS public.find_user_by_contact(text);
...
-- Temporarily disable foreign key constraint to modify user_profiles
...
GRANT INSERT ON user_accounts TO authenticated;
